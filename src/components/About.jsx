  ...
  return (
    <div name="about" className="w-full h-screen bg-gradient-to-b from-gray-800 to to-black text-white">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className='text-xl mt-20'>1-year experiencd Full Stack Software Developer, having worked on multiple production projects in a highly paced product-based Ed-tech Startup environment.</p>
        <br />
